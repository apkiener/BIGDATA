...
setwd(dir)
data<-read.csv("/Users/apkiener/Desktop/Homework_1_DATA.csv"
,sep=";",dec=",", header = TRUE)
...
series5=data[,5] [1:300]
series6=data[,6] [1:300]
series7=data[,7]
...
#pvalue < 0.05 reject null- no white noise
# Ho: uncorrelated data= white noise
# H1: correlated data = nonwhite noise
